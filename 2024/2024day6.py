...
def get_distinct_position_count(map, guardCoord, guardDir, checkLoop = False):
  ...
  map[guardCoord[0], guardCoord[1]] = "X"
  distPos = 1
  loopCount = 0
  ...
  while not guardLeft:
    ...
    repeatCount = collections.Counter(map[up + 1 : down, left + 1 : right].flatten())["X"]
    map[up + 1 : down, left + 1 : right] = "X"
